 ...
 */
public class FragmentUidValidationTask extends AbstractUidValidationTask {

    public FragmentUidValidationTask(ArtifactBuilder artifactBuilder, Path artifactsSourceDir) {
