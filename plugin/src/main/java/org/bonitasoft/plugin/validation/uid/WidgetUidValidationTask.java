 ...
 */
public class WidgetUidValidationTask extends AbstractUidValidationTask {

    public WidgetUidValidationTask(ArtifactBuilder artifactBuilder, Path artifactsSourceDir) {
