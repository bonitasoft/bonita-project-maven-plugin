...
public class CreateBdmModuleMojo extends AbstractMojo {
    ...
    @Parameter(defaultValue = "${project.basedir}/bdm")
    protected File bdmModuleFolder;

    private BuildContext buildContext;
    private BdmModuleGenerator moduleGenerator;

    @Inject
    public CreateBdmModuleMojo(BdmModuleGenerator moduleGenerator,
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            moduleGenerator.generate(bdmModuleFolder, project);
        ...
        buildContext.refresh(bdmModuleFolder);
