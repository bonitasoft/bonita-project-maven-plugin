...
File jarFile = new File( localRepositoryPath, 'org/bonitasoft/connectors/bonita/5.4/bonita-5.4.jar');
if ( !jarFile.isFile() ) {
    throw new FileNotFoundException( "Could not find installed JAR: " + jarFile );
}

File pomFile = new File( localRepositoryPath, 'org/bonitasoft/connectors/bonita/5.4/bonita-5.4.pom');
if ( !pomFile.isFile() ) {
